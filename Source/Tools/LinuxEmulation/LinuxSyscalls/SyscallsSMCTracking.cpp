...
namespace FEX::HLE {
  ...
  void SyscallHandler::TrackMremap(
  FEXCore::Core::InternalThreadState *Thread, uintptr_t OldAddress, size_t OldSize, size_t NewSize, int flags, uintptr_t NewAddress) {
...
// MREMAP_DONTUNMAP is kernel 5.7+
  ...
  void SyscallHandler::TrackShmat(FEXCore::Core::InternalThreadState *Thread, int shmid, uintptr_t Base, int shmflg) {
...

    {
      ...
      VMATracking.SetUnsafe(
      CTX, Resource, Base, 0, Length, VMAFlags::fromFlags(MAP_SHARED),
