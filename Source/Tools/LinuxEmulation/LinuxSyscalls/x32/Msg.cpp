...
namespace FEX::HLE::x32 {
  void RegisterMsg(FEX::HLE::SyscallHandler *Handler) {
    ...
    mq_timedsend,
    [](
    FEXCore::Core::CpuStateFrame *Frame, FEX::HLE::mqd_t mqdes, const char *msg_ptr, size_t msg_len, unsigned int msg_prio,
    const struct timespec32 *abs_timeout) -> uint64_t {
    ...
    REGISTER_SYSCALL_IMPL_X32(
    mq_timedreceive,
    [](FEXCore::Core::CpuStateFrame *Frame, FEX::HLE::mqd_t mqdes, char *msg_ptr, size_t msg_len, unsigned int *msg_prio, const struct timespec32 *abs_timeout)
    -> uint64_t {
      struct timespec tp64 {};
      struct timespec *timed_ptr{};
      if (abs_timeout) {
    ...
    [](FEXCore::Core::CpuStateFrame *Frame, FEX::HLE::mqd_t mqdes, const char *msg_ptr, size_t msg_len, unsigned int msg_prio, const struct timespec *abs_timeout)
    -> uint64_t {
    ...
    [](FEXCore::Core::CpuStateFrame *Frame, FEX::HLE::mqd_t mqdes, char *msg_ptr, size_t msg_len, unsigned int *msg_prio, const struct timespec *abs_timeout)
    -> uint64_t {
    ...
    REGISTER_SYSCALL_IMPL_X32(
    mq_getsetattr,
    [](FEXCore::Core::CpuStateFrame *Frame, FEX::HLE::mqd_t mqdes, compat_ptr<FEX::HLE::x32::mq_attr32> newattr, compat_ptr<FEX::HLE::x32::mq_attr32> oldattr)
    -> uint64_t {
      mq_attr HostNew{};
      mq_attr *HostNew_p{};
