...
namespace FEX::HLE {
  void RegisterIOUring(FEX::HLE::SyscallHandler *Handler) {
    ...
    if (Handler->IsHostKernelVersionAtLeast(5, 1, 0)) {
      ...
      io_uring_setup, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
      ...
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(
      io_uring_enter, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
