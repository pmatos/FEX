...
namespace FEX::HLE {
  void RegisterNamespace(FEX::HLE::SyscallHandler *Handler) {
    ...
    if (Handler->GetHostKernelVersion() >= FEX::HLE::SyscallHandler::KernelVersion(5, 1, 0)) {
      ...
      open_tree, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
      ...
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(
      move_mount, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
      ...
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(
      fsopen, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
      ...
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(
      fsmount, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
      ...
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(
      fspick, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
      [](FEXCore::Core::CpuStateFrame *Frame, int dfd, const char *path, unsigned int flags) -> uint64_t {
