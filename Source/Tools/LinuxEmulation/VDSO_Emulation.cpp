...
namespace FEX::VDSO {
  ...
  void LoadGuestVDSOSymbols(bool Is64Bit, char *VDSOBase) {
    ...
    for (size_t i = 0; i < NumSymbols; ++i) {
      ...
      Elf32_Sym const *Symbol = reinterpret_cast<Elf32_Sym const *>(VDSOBase + offset);
  ...
  fextl::vector<FEXCore::IR::ThunkDefinition> const &GetVDSOThunkDefinitions() { return VDSODefinitions; }

  FEXCore::Context::VDSOSigReturn const &GetVDSOSymbols() { return VDSOPointers; }
}
