...
check_relerr rel eresult11, rel result11
mov ebx, eax
check_relerr rel eresult12, rel result12
and ebx, eax
check_relerr rel eresult21, rel result21
and ebx, eax
check_relerr rel eresult22, rel result22
and ebx, eax
check_relerr rel eresult31, rel result31
and ebx, eax
check_relerr rel eresult32, rel result32
and ebx, eax
