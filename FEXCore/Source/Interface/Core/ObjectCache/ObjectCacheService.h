...
namespace FEXCore::CodeSerialize {
  ...
  struct CodeRegionEntry {
    ...
    CodeRegionEntry(uint64_t Base, uint64_t Size, uint64_t Offset, fextl::string const &Filename, CodeObjectSerializationHeader const &DefaultHeader)
      : Base{Base},
        Size{Size},
        Offset{Offset},
        Filename{Filename},
  ...
  protected:
    ...
    protected:
      ...
      NamedRegionWorkItem(NamedRegionJobType type) : Type{type} {}
  ...
  public:
    ...
    CodeObjectSerializationConfig const &GetDefaultSerializationConfig() const { return DefaultSerializationConfig; }
  ...
  public:
    ...
    /**
         ...
         * @param Size - The size of the region
         */
    void AsyncRemoveNamedRegionJob(uintptr_t Base, uintptr_t Size) { AsyncHandler.AsyncRemoveNamedRegionJob(Base, Size); }
