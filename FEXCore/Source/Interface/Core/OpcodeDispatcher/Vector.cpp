...
#define OpcodeArgs [[maybe_unused]] FEXCore::X86Tables::DecodedOp Op
  ...
  template<IROps IROp, size_t ElementSize> void OpDispatchBuilder::VectorALUOp(OpcodeArgs) { VectorALUOpImpl(Op, IROp, ElementSize); }
  ...
  template<IROps IROp, size_t ElementSize> void OpDispatchBuilder::AVXVectorALUOp(OpcodeArgs) { AVXVectorALUOpImpl(Op, IROp, ElementSize); }
  ...
  template<IROps IROp, size_t ElementSize> void OpDispatchBuilder::VectorALUROp(OpcodeArgs) { VectorALUROpImpl(Op, IROp, ElementSize); }
  ...
  OrderedNode *OpDispatchBuilder::VectorScalarInsertALUOpImpl(
  ...
  template<IROps IROp, size_t ElementSize> void OpDispatchBuilder::VectorScalarInsertALUOp(OpcodeArgs) {
  ...
  template<IROps IROp, size_t ElementSize> void OpDispatchBuilder::AVXVectorScalarInsertALUOp(OpcodeArgs) {
    const auto DstSize = GetGuestVectorLength();
  ...
  OrderedNode *OpDispatchBuilder::VectorScalarUnaryInsertALUOpImpl(
  OpcodeArgs, IROps IROp, size_t DstSize, size_t ElementSize, const X86Tables::DecodedOperand &Src1Op,
  const X86Tables::DecodedOperand &Src2Op, bool ZeroUpperBits) {
    // We load the full vector width when dealing with a source vector,
    // so that we don't do any unnecessary zero extension to the scalar
  ...
  template<IROps IROp, size_t ElementSize> void OpDispatchBuilder::VectorScalarUnaryInsertALUOp(OpcodeArgs) {
    const auto DstSize = GetGuestVectorLength();
    auto Result = VectorScalarInsertALUOpImpl(Op, IROp, DstSize, ElementSize, Op->Dest, Op->Src[0], false);
    StoreResult_WithOpSize(FPRClass, Op, Op->Dest, Result, DstSize, -1);
  }
  ...
  template<IROps IROp, size_t ElementSize> void OpDispatchBuilder::AVXVectorScalarUnaryInsertALUOp(OpcodeArgs) {
    const auto DstSize = GetGuestVectorLength();
    auto Result = VectorScalarInsertALUOpImpl(Op, IROp, DstSize, ElementSize, Op->Src[0], Op->Src[1], true);
    StoreResult_WithOpSize(FPRClass, Op, Op->Dest, Result, DstSize, -1);
  }
  ...
  OrderedNode *OpDispatchBuilder::InsertCVTGPR_To_FPRImpl(
  ...
  template<size_t DstElementSize> void OpDispatchBuilder::InsertCVTGPR_To_FPR(OpcodeArgs) {
    const auto DstSize = GetGuestVectorLength();
  ...
  template<size_t DstElementSize> void OpDispatchBuilder::AVXInsertCVTGPR_To_FPR(OpcodeArgs) {
    const auto DstSize = GetGuestVectorLength();
  ...
  OrderedNode *OpDispatchBuilder::InsertScalar_CVT_Float_To_FloatImpl(
  ...
  template<size_t DstElementSize, size_t SrcElementSize> void OpDispatchBuilder::InsertScalar_CVT_Float_To_Float(OpcodeArgs) {
    const auto DstSize = GetGuestVectorLength();
  ...
  template<size_t DstElementSize, size_t SrcElementSize> void OpDispatchBuilder::AVXInsertScalar_CVT_Float_To_Float(OpcodeArgs) {
    const auto DstSize = GetGuestVectorLength();
  ...
  OrderedNode *OpDispatchBuilder::InsertScalarRoundImpl(
  ...
  template<size_t ElementSize> void OpDispatchBuilder::InsertScalarRound(OpcodeArgs) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::AVXInsertScalarRound(OpcodeArgs) {
  ...
  OrderedNode *OpDispatchBuilder::InsertScalarFCMPOpImpl(
  OpcodeArgs, size_t DstSize, size_t ElementSize, const X86Tables::DecodedOperand &Src1Op, const X86Tables::DecodedOperand &Src2Op,
  ...
  template<size_t ElementSize> void OpDispatchBuilder::InsertScalarFCMPOp(OpcodeArgs) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::AVXInsertScalarFCMPOp(OpcodeArgs) {
  ...
  template<IROps IROp, size_t ElementSize> void OpDispatchBuilder::VectorUnaryOp(OpcodeArgs) { VectorUnaryOpImpl(Op, IROp, ElementSize); }
  ...
  template<IROps IROp, size_t ElementSize> void OpDispatchBuilder::AVXVectorUnaryOp(OpcodeArgs) {
  ...
  template<IROps IROp, size_t ElementSize> void OpDispatchBuilder::VectorUnaryDuplicateOp(OpcodeArgs) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::MOVMSKOp(OpcodeArgs) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PUNPCKLOp(OpcodeArgs) {
    auto Size = GetSrcSize(Op);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPUNPCKLOp(OpcodeArgs) {
    const auto SrcSize = GetSrcSize(Op);
    const auto Is128Bit = SrcSize == Core::CPUState::XMM_SSE_REG_SIZE;
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PUNPCKHOp(OpcodeArgs) {
    auto Size = GetSrcSize(Op);
    OrderedNode *Dest = LoadSource(FPRClass, Op, Op->Dest, Op->Flags);
    OrderedNode *Src = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPUNPCKHOp(OpcodeArgs) {
    const auto SrcSize = GetSrcSize(Op);
    const auto Is128Bit = SrcSize == Core::CPUState::XMM_SSE_REG_SIZE;
  ...
  template<bool Low> void OpDispatchBuilder::PSHUFWOp(OpcodeArgs) {
    constexpr auto IdentityCopy = 0b11'10'01'00;
  ...
  template<size_t ElementSize, bool Low> void OpDispatchBuilder::VPSHUFWOp(OpcodeArgs) {
    const auto SrcSize = GetSrcSize(Op);
    const auto Is256Bit = SrcSize == Core::CPUState::XMM_AVX_REG_SIZE;
  ...
  OrderedNode *OpDispatchBuilder::SHUFOpImpl(
  ...
  template<size_t ElementSize> void OpDispatchBuilder::SHUFOp(OpcodeArgs) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VSHUFOp(OpcodeArgs) {
  ...
  template<IROps IROp, size_t ElementSize> void OpDispatchBuilder::VHADDPOp(OpcodeArgs) {
    const auto SrcSize = GetSrcSize(Op);
    const auto Is256Bit = SrcSize == Core::CPUState::XMM_AVX_REG_SIZE;
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VBROADCASTOp(OpcodeArgs) {
  ...
  OrderedNode *OpDispatchBuilder::PINSROpImpl(
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PINSROp(OpcodeArgs) {
  ...
  OrderedNode *OpDispatchBuilder::InsertPSOpImpl(
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PExtrOp(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PSIGN(OpcodeArgs) {
    OrderedNode *Src = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
    OrderedNode *Dest = LoadSource(FPRClass, Op, Op->Dest, Op->Flags);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPSIGN(OpcodeArgs) {
    OrderedNode *Src1 = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
    OrderedNode *Src2 = LoadSource(FPRClass, Op, Op->Src[1], Op->Flags);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PSRLDOp(OpcodeArgs) {
    OrderedNode *Dest = LoadSource(FPRClass, Op, Op->Dest, Op->Flags);
    OrderedNode *Src = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPSRLDOp(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PSRLI(OpcodeArgs) {
    LOGMAN_THROW_A_FMT(Op->Src[1].IsLiteral(), "Src[1] needs to be literal here");
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPSRLIOp(OpcodeArgs) {
    const auto Size = GetSrcSize(Op);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PSLLI(OpcodeArgs) {
    LOGMAN_THROW_A_FMT(Op->Src[1].IsLiteral(), "Src[1] needs to be literal here");
    const uint64_t ShiftConstant = Op->Src[1].Data.Literal.Value;
    if (ShiftConstant == 0) [[unlikely]] {
      // Nothing to do, value is already in Dest.
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPSLLIOp(OpcodeArgs) {
    LOGMAN_THROW_A_FMT(Op->Src[1].IsLiteral(), "Src1 needs to be literal here");
    const uint64_t ShiftConstant = Op->Src[1].Data.Literal.Value;
    const auto DstSize = GetDstSize(Op);
    const auto Is128Bit = DstSize == Core::CPUState::XMM_SSE_REG_SIZE;
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PSLL(OpcodeArgs) {
    OrderedNode *Dest = LoadSource(FPRClass, Op, Op->Dest, Op->Flags);
    OrderedNode *Src = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPSLLOp(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
    const auto Is128Bit = DstSize == Core::CPUState::XMM_SSE_REG_SIZE;
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PSRAOp(OpcodeArgs) {
    OrderedNode *Dest = LoadSource(FPRClass, Op, Op->Dest, Op->Flags);
    OrderedNode *Src = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPSRAOp(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
    const auto Is128Bit = DstSize == Core::CPUState::XMM_SSE_REG_SIZE;
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PSRAIOp(OpcodeArgs) {
    LOGMAN_THROW_A_FMT(Op->Src[1].IsLiteral(), "Src[1] needs to be literal here");
    const uint64_t Shift = Op->Src[1].Data.Literal.Value;
    if (Shift == 0) [[unlikely]] {
      // Nothing to do, value is already in Dest.
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPSRAIOp(OpcodeArgs) {
    LOGMAN_THROW_A_FMT(Op->Src[1].IsLiteral(), "Src1 needs to be literal here");
    const uint64_t Shift = Op->Src[1].Data.Literal.Value;
    const auto Size = GetDstSize(Op);
    const auto Is128Bit = Size == Core::CPUState::XMM_SSE_REG_SIZE;
  ...
  void OpDispatchBuilder::VMOVDDUPOp(OpcodeArgs) {
    ...
    OrderedNode *Src = IsSrcGPR
    ? LoadSource_WithOpSize(FPRClass, Op, Op->Src[0], SrcSize, Op->Flags)
  ...
  OrderedNode *OpDispatchBuilder::CVTGPR_To_FPRImpl(
  OpcodeArgs, size_t DstElementSize, const X86Tables::DecodedOperand &Src1Op, const X86Tables::DecodedOperand &Src2Op) {
    const auto SrcSize = GetSrcSize(Op);
  ...
  template<size_t DstElementSize> void OpDispatchBuilder::CVTGPR_To_FPR(OpcodeArgs) {
  ...
  template<size_t DstElementSize> void OpDispatchBuilder::AVXCVTGPR_To_FPR(OpcodeArgs) {
  ...
  template<size_t SrcElementSize, bool HostRoundingMode> void OpDispatchBuilder::CVTFPR_To_GPR(OpcodeArgs) {
    // If loading a vector, use the full size, so we don't
    // unnecessarily zero extend the vector. Otherwise, if
    // memory, then we want to load the element size exactly.
    const auto SrcSize = Op->Src[0].IsGPR() ? 16U : GetSrcSize(Op);
  ...
  template<size_t SrcElementSize, bool Widen> void OpDispatchBuilder::Vector_CVT_Int_To_Float(OpcodeArgs) {
  ...
  template<size_t SrcElementSize, bool Widen> void OpDispatchBuilder::AVXVector_CVT_Int_To_Float(OpcodeArgs) {
    OrderedNode *Result = Vector_CVT_Int_To_FloatImpl(Op, SrcElementSize, Widen);
    StoreResult(FPRClass, Op, Result, -1);
  }
  ...
  template<size_t SrcElementSize, bool Narrow, bool HostRoundingMode> void OpDispatchBuilder::Vector_CVT_Float_To_Int(OpcodeArgs) {
    const size_t DstSize = GetDstSize(Op);
  ...
  template<size_t SrcElementSize, bool Narrow, bool HostRoundingMode> void OpDispatchBuilder::AVXVector_CVT_Float_To_Int(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
  ...
  template<size_t DstElementSize, size_t SrcElementSize> void OpDispatchBuilder::Scalar_CVT_Float_To_Float(OpcodeArgs) {
  ...
  template<size_t DstElementSize, size_t SrcElementSize> void OpDispatchBuilder::AVXScalar_CVT_Float_To_Float(OpcodeArgs) {
  ...
  template<size_t DstElementSize, size_t SrcElementSize> void OpDispatchBuilder::Vector_CVT_Float_To_Float(OpcodeArgs) {
  ...
  template<size_t DstElementSize, size_t SrcElementSize> void OpDispatchBuilder::AVXVector_CVT_Float_To_Float(OpcodeArgs) {
  ...
  template<size_t SrcElementSize, bool Narrow, bool HostRoundingMode> void OpDispatchBuilder::XMM_To_MMX_Vector_CVT_Float_To_Int(OpcodeArgs) {
    // If loading a vector, use the full size, so we don't
    // unnecessarily zero extend the vector. Otherwise, if
    // memory, then we want to load the element size exactly.
    const auto SrcSize = Op->Src[0].IsGPR() ? 16U : GetSrcSize(Op);
  ...
  void OpDispatchBuilder::VMASKMOVOpImpl(
  ...
  template<size_t ElementSize, bool IsStore> void OpDispatchBuilder::VMASKMOVOp(OpcodeArgs) {
  ...
  template<bool IsStore> void OpDispatchBuilder::VPMASKMOVOp(OpcodeArgs) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VFCMPOp(OpcodeArgs) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::AVXVFCMPOp(OpcodeArgs) {
    // No need for zero-extending in the scalar case, since
    // all we need is an insert at the end of the operation.
    const auto SrcSize = GetSrcSize(Op);
    const auto DstSize = GetDstSize(Op);
  ...
  OrderedNode *OpDispatchBuilder::PALIGNROpImpl(
  ...
  template<size_t ElementSize> void OpDispatchBuilder::UCOMISxOp(OpcodeArgs) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PACKUSOp(OpcodeArgs) {
    OrderedNode *Dest = LoadSource(FPRClass, Op, Op->Dest, Op->Flags);
    OrderedNode *Src = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPACKUSOp(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
    const auto Is256Bit = DstSize == Core::CPUState::XMM_AVX_REG_SIZE;
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PACKSSOp(OpcodeArgs) {
    OrderedNode *Dest = LoadSource(FPRClass, Op, Op->Dest, Op->Flags);
    OrderedNode *Src = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPACKSSOp(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
    const auto Is256Bit = DstSize == Core::CPUState::XMM_AVX_REG_SIZE;
  ...
  template<size_t ElementSize, bool Signed> void OpDispatchBuilder::PMULLOp(OpcodeArgs) {
  ...
  template<size_t ElementSize, bool Signed> void OpDispatchBuilder::VPMULLOp(OpcodeArgs) {
    static_assert(ElementSize == sizeof(uint32_t), "Currently only handles 32-bit -> 64-bit");
  ...
  template<bool ToXMM> void OpDispatchBuilder::MOVQ2DQ(OpcodeArgs) {
    OrderedNode *Src = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::ADDSUBPOp(OpcodeArgs) {
    OrderedNode *Dest = LoadSource(FPRClass, Op, Op->Dest, Op->Flags);
    OrderedNode *Src = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VADDSUBPOp(OpcodeArgs) {
    OrderedNode *Src1 = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
    OrderedNode *Src2 = LoadSource(FPRClass, Op, Op->Src[1], Op->Flags);
  ...
  template<uint8_t CompType> void OpDispatchBuilder::VPFCMPOp(OpcodeArgs) {
    auto Size = GetSrcSize(Op);
    OrderedNode *Src = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
  ...
  template<bool Signed> void OpDispatchBuilder::PMULHW(OpcodeArgs) {
    OrderedNode *Dest = LoadSource(FPRClass, Op, Op->Dest, Op->Flags);
    OrderedNode *Src = LoadSource(FPRClass, Op, Op->Src[0], Op->Flags);
  ...
  template<bool Signed> void OpDispatchBuilder::VPMULHWOp(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
    const auto Is128Bit = DstSize == Core::CPUState::XMM_SSE_REG_SIZE;
  ...
  OrderedNode *OpDispatchBuilder::HSUBPOpImpl(OpcodeArgs, size_t ElementSize, const X86Tables::DecodedOperand &Src1Op, const X86Tables::DecodedOperand &Src2Op) {
    const auto SrcSize = GetSrcSize(Op);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::HSUBP(OpcodeArgs) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VHSUBPOp(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
    const auto Is256Bit = DstSize == Core::CPUState::XMM_AVX_REG_SIZE;
  ...
  OrderedNode *OpDispatchBuilder::PHSUBOpImpl(OpcodeArgs, const X86Tables::DecodedOperand &Src1, const X86Tables::DecodedOperand &Src2, size_t ElementSize) {
    const auto Size = GetSrcSize(Op);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::PHSUB(OpcodeArgs) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPHSUBOp(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
    const auto Is256Bit = DstSize == Core::CPUState::XMM_AVX_REG_SIZE;
  ...
  template<size_t ElementSize, size_t DstElementSize, bool Signed> void OpDispatchBuilder::ExtendVectorElements(OpcodeArgs) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VectorRound(OpcodeArgs) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::AVXVectorRound(OpcodeArgs) {
    LOGMAN_THROW_A_FMT(Op->Src[1].IsLiteral(), "Src1 needs to be literal here");
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VectorBlend(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VectorVariableBlend(OpcodeArgs) {
    auto Size = GetSrcSize(Op);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::AVXVectorVariableBlend(OpcodeArgs) {
    const auto SrcSize = GetSrcSize(Op);
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VTESTPOp(OpcodeArgs) { VTESTOpImpl(Op, ElementSize); }
  ...
  OrderedNode *OpDispatchBuilder::DPPOpImpl(
  OpcodeArgs, const X86Tables::DecodedOperand &Src1, const X86Tables::DecodedOperand &Src2, const X86Tables::DecodedOperand &Imm, size_t ElementSize) {
    LOGMAN_THROW_A_FMT(Imm.IsLiteral(), "Imm needs to be literal here");
  ...
  template<size_t ElementSize> void OpDispatchBuilder::DPPOp(OpcodeArgs) {
  ...
  OrderedNode *OpDispatchBuilder::VDPPSOpImpl(
  OpcodeArgs, const X86Tables::DecodedOperand &Src1, const X86Tables::DecodedOperand &Src2, const X86Tables::DecodedOperand &Imm) {
    LOGMAN_THROW_A_FMT(Imm.IsLiteral(), "Imm needs to be literal here");
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VDPPOp(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
  ...
  OrderedNode *OpDispatchBuilder::MPSADBWOpImpl(
  ...
  static OrderedNode *VBLENDOpImpl(
  IREmitter &IR, uint32_t VecSize, uint32_t ElementSize, OrderedNode *Src1, OrderedNode *Src2, OrderedNode *ZeroRegister, uint64_t Selector) {
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPERMILImmOp(OpcodeArgs) {
    const auto DstSize = GetDstSize(Op);
    const auto Is256Bit = DstSize == Core::CPUState::XMM_AVX_REG_SIZE;
  ...
  template<size_t ElementSize> void OpDispatchBuilder::VPERMILRegOp(OpcodeArgs) {
  ...
  void OpDispatchBuilder::PCMPXSTRXOpImpl(OpcodeArgs, bool IsExplicit, bool IsMask) {
    ...
    //      [OF | CF | SF | ZF]
    //
    const auto GetFlagBit = [this, IntermediateResult](int BitIndex) { return _Bfe(OpSize::i32Bit, 1, BitIndex, IntermediateResult); };
