...
#define OpcodeArgs [[maybe_unused]] FEXCore::X86Tables::DecodedOp Op
  ...
  template<size_t width> void OpDispatchBuilder::FLDF64(OpcodeArgs) {
    // Update TOP
  ...
  template<uint64_t num> void OpDispatchBuilder::FLDF64_Const(OpcodeArgs) {
    // Update TOP
    auto orig_top = GetX87Top();
  ...
  template<size_t width> void OpDispatchBuilder::FSTF64(OpcodeArgs) {
    auto orig_top = GetX87Top();
    auto data = _LoadContextIndexed(orig_top, 8, MMBaseOffset(), 16, FPRClass);
  ...
  template<bool Truncate> void OpDispatchBuilder::FISTF64(OpcodeArgs) {
    auto Size = GetSrcSize(Op);
  ...
  template<size_t width, bool Integer, OpDispatchBuilder::OpResult ResInST0> void OpDispatchBuilder::FADDF64(OpcodeArgs) {
    auto top = GetX87Top();
  ...
  template<size_t width, bool Integer, OpDispatchBuilder::OpResult ResInST0> void OpDispatchBuilder::FMULF64(OpcodeArgs) {
    auto top = GetX87Top();
    OrderedNode *StackLocation = top;
    OrderedNode *arg{};
    OrderedNode *b{};
  ...
  template<size_t width, bool Integer, bool reverse, OpDispatchBuilder::OpResult ResInST0> void OpDispatchBuilder::FDIVF64(OpcodeArgs) {
    auto top = GetX87Top();
    OrderedNode *StackLocation = top;
    OrderedNode *arg{};
    OrderedNode *b{};
  ...
  template<size_t width, bool Integer, bool reverse, OpDispatchBuilder::OpResult ResInST0> void OpDispatchBuilder::FSUBF64(OpcodeArgs) {
    auto top = GetX87Top();
    OrderedNode *StackLocation = top;
    OrderedNode *arg{};
    OrderedNode *b{};
  ...
  template<size_t width, bool Integer, OpDispatchBuilder::FCOMIFlags whichflags, bool poptwice> void OpDispatchBuilder::FCOMIF64(OpcodeArgs) {
    auto top = GetX87Top();
    auto mask = _Constant(7);
  ...
  template<FEXCore::IR::IROps IROp> void OpDispatchBuilder::X87UnaryOpF64(OpcodeArgs) {
    auto top = GetX87Top();
    auto a = _LoadContextIndexed(top, 8, MMBaseOffset(), 16, FPRClass);
  ...
  template<FEXCore::IR::IROps IROp> void OpDispatchBuilder::X87BinaryOpF64(OpcodeArgs) {
    auto top = GetX87Top();
