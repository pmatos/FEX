...
#define OpcodeArgs [[maybe_unused]] FEXCore::X86Tables::DecodedOp Op
  ...
  void OpDispatchBuilder::SHA1RNDS4Op(OpcodeArgs) {
    ...
    const auto Round1To3 =
    [&](OrderedNode *A, OrderedNode *B, OrderedNode *C, OrderedNode *D, OrderedNode *E, OrderedNode *Src, unsigned W_idx) -> RoundResult {
  ...
  void OpDispatchBuilder::SHA256MSG1Op(OpcodeArgs) {
    ...
    if (CTX->HostFeatures.SupportsSHA) {
      ...
      const auto Sigma0 = [this](OrderedNode *W) -> OrderedNode * {
        return _Xor(
        OpSize::i32Bit, _Xor(OpSize::i32Bit, _Ror(OpSize::i32Bit, W, _Constant(32, 7)), _Ror(OpSize::i32Bit, W, _Constant(32, 18))),
  ...
  void OpDispatchBuilder::SHA256MSG2Op(OpcodeArgs) {
    const auto Sigma1 = [this](OrderedNode *W) -> OrderedNode * {
      return _Xor(
      OpSize::i32Bit, _Xor(OpSize::i32Bit, _Ror(OpSize::i32Bit, W, _Constant(32, 17)), _Ror(OpSize::i32Bit, W, _Constant(32, 19))),
