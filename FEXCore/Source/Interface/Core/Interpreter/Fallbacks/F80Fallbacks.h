...
namespace FEXCore::CPU {
  ...
  template<> struct OpHandlers<IR::OP_F80CVTTO> {
    FEXCORE_PRESERVE_ALL_ATTR
  ...
  template<> struct OpHandlers<IR::OP_F80CMP> {
    template<uint32_t Flags> FEXCORE_PRESERVE_ALL_ATTR static uint64_t handle(uint16_t NewFCW, X80SoftFloat Src1, X80SoftFloat Src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80CVT> {
    FEXCORE_PRESERVE_ALL_ATTR
  ...
  template<> struct OpHandlers<IR::OP_F80CVTINT> {
    FEXCORE_PRESERVE_ALL_ATTR
  ...
  template<> struct OpHandlers<IR::OP_F80CVTTOINT> {
    FEXCORE_PRESERVE_ALL_ATTR
  ...
  template<> struct OpHandlers<IR::OP_F80ROUND> {
    FEXCORE_PRESERVE_ALL_ATTR
  ...
  template<> struct OpHandlers<IR::OP_F80F2XM1> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80TAN> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80SQRT> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80SIN> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80COS> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80XTRACT_EXP> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80XTRACT_SIG> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80ADD> {
    FEXCORE_PRESERVE_ALL_ATTR
  ...
  template<> struct OpHandlers<IR::OP_F80SUB> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1, X80SoftFloat Src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80MUL> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1, X80SoftFloat Src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80DIV> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1, X80SoftFloat Src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80FYL2X> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1, X80SoftFloat Src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80ATAN> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1, X80SoftFloat Src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80FPREM1> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1, X80SoftFloat Src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80FPREM> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1, X80SoftFloat Src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80SCALE> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1, X80SoftFloat Src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F64SIN> {
  ...
  template<> struct OpHandlers<IR::OP_F64COS> {
    static double handle(uint16_t NewFCW, double src) {
      LoadDeferredFCW(NewFCW);
      return cos(src);
    }
  ...
  template<> struct OpHandlers<IR::OP_F64TAN> {
    static double handle(uint16_t NewFCW, double src) {
      LoadDeferredFCW(NewFCW);
      return tan(src);
    }
  ...
  template<> struct OpHandlers<IR::OP_F64F2XM1> {
    static double handle(uint16_t NewFCW, double src) {
      LoadDeferredFCW(NewFCW);
      return exp2(src) - 1.0;
    }
  ...
  template<> struct OpHandlers<IR::OP_F64ATAN> {
  ...
  template<> struct OpHandlers<IR::OP_F64FPREM> {
    static double handle(uint16_t NewFCW, double src1, double src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F64FPREM1> {
    static double handle(uint16_t NewFCW, double src1, double src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F64FYL2X> {
    static double handle(uint16_t NewFCW, double src1, double src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F64SCALE> {
    static double handle(uint16_t NewFCW, double src1, double src2) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80BCDSTORE> {
    FEXCORE_PRESERVE_ALL_ATTR
    static X80SoftFloat handle(uint16_t NewFCW, X80SoftFloat Src1) {
      LoadDeferredFCW(NewFCW);
  ...
  template<> struct OpHandlers<IR::OP_F80BCDLOAD> {
    FEXCORE_PRESERVE_ALL_ATTR
