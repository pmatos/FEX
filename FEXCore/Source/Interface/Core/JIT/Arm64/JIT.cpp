...
namespace FEXCore::CPU {
  ...
  CPUBackend::CompiledCode Arm64JITCore::CompileCode(
  uint64_t Entry, FEXCore::IR::IRListView const *IR, FEXCore::Core::DebugData *DebugData, FEXCore::IR::RegisterAllocationData *RAData) {
...
#undef REGISTER_OP
      ...
      if (DebugData) {
        ...
        {static_cast<uint32_t>(BlockStartHostCode - CodeData.BlockEntry), static_cast<uint32_t>(GetCursorAddress<uint8_t *>() - BlockStartHostCode)});
      }
    }
