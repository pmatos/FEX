...
namespace FEXCore::CPU {
  ...
  public:
    ...
    [[nodiscard]] CPUBackend::CompiledCode CompileCode(
    uint64_t Entry, FEXCore::IR::IRListView const *IR, FEXCore::Core::DebugData *DebugData, FEXCore::IR::RegisterAllocationData *RAData) override;
  ...
  private:
    ...
    [[nodiscard]] ARMEmitter::ShiftType ConvertIRShiftType(IR::ShiftType Shift) const {
      ...
      : Shift == IR::ShiftType::ASR
      ? ARMEmitter::ShiftType::ASR
    ...
    [[nodiscard]] FEXCore::ARMEmitter::ExtendedMemOperand GenerateMemOperand(
    ...
    [[nodiscard]] FEXCore::ARMEmitter::SVEMemOperand GenerateSVEMemOperand(
    uint8_t AccessSize, FEXCore::ARMEmitter::Register Base, IR::OrderedNodeWrapper Offset, IR::MemOffsetType OffsetType, uint8_t OffsetScale);
   ...
   * @{ */
    ...
    void VFScalarOperation(
    uint8_t OpSize, uint8_t ElementSize, bool ZeroUpperBits, ScalarBinaryOpCaller ScalarEmit, ARMEmitter::VRegister Dst,
    ARMEmitter::VRegister Vector1, ARMEmitter::VRegister Vector2);
    ...
    void VFScalarUnaryOperation(
    uint8_t OpSize, uint8_t ElementSize, bool ZeroUpperBits, ScalarUnaryOpCaller ScalarEmit, ARMEmitter::VRegister Dst,
