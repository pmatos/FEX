...
namespace FEXCore::IR {
  ...
  public:
    InlineCallOptimization(const FEXCore::CPUIDEmu* CPUID) : CPUID{CPUID} {}
        ...
        if (IREmit->IsValueConstant(Op->SyscallID, &Constant)) {
          ...
          if (SyscallDef.NumArgs < FEXCore::HLE::SyscallArguments::MAX_ARGS) {
            ...
            if (SyscallDef.HostSyscallNumber != -1) {
              ...
              CurrentIR.GetNode(IROp->Args[1]), CurrentIR.GetNode(IROp->Args[2]), CurrentIR.GetNode(IROp->Args[3]),
