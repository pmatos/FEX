...
namespace FEXCore::IR {
  namespace {
    ...
    public:
      template<typename Type> std::pair<DecodeFailure, Type> DecodeValue(const fextl::string &Arg) {
        return {DecodeFailure::DECODE_UNKNOWN_TYPE, {}};
      }

      template<> std::pair<DecodeFailure, uint8_t> DecodeValue(const fextl::string &Arg) {
      ...
      template<> std::pair<DecodeFailure, bool> DecodeValue(const fextl::string &Arg) {
        if (Arg.at(0) != '#') return {DecodeFailure::DECODE_INVALIDCHAR, 0};
      ...
      template<> std::pair<DecodeFailure, uint16_t> DecodeValue(const fextl::string &Arg) {
        if (Arg.at(0) != '#') return {DecodeFailure::DECODE_INVALIDCHAR, 0};
      ...
      template<> std::pair<DecodeFailure, uint32_t> DecodeValue(const fextl::string &Arg) {
        if (Arg.at(0) != '#') return {DecodeFailure::DECODE_INVALIDCHAR, 0};
      ...
      template<> std::pair<DecodeFailure, uint64_t> DecodeValue(const fextl::string &Arg) {
        if (Arg.at(0) != '#') return {DecodeFailure::DECODE_INVALIDCHAR, 0};
      ...
      template<> std::pair<DecodeFailure, int64_t> DecodeValue(const fextl::string &Arg) {
        if (Arg.at(0) != '#') return {DecodeFailure::DECODE_INVALIDCHAR, 0};
      ...
      template<> std::pair<DecodeFailure, IR::SHA256Sum> DecodeValue(const fextl::string &Arg) {
        IR::SHA256Sum Result;
      ...
      template<> std::pair<DecodeFailure, FEXCore::IR::RegisterClassType> DecodeValue(const fextl::string &Arg) {
        if (Arg == "GPR") {
      ...
      template<> std::pair<DecodeFailure, FEXCore::IR::TypeDefinition> DecodeValue(const fextl::string &Arg) {
      ...
      template<> std::pair<DecodeFailure, FEXCore::IR::CondClassType> DecodeValue(const fextl::string &Arg) {
      ...
      template<> std::pair<DecodeFailure, FEXCore::IR::MemOffsetType> DecodeValue(const fextl::string &Arg) {
      ...
      template<> std::pair<DecodeFailure, FEXCore::IR::FenceType> DecodeValue(const fextl::string &Arg) {
        static constexpr std::array<std::string_view, 3> Names = {
        "Loads",
        "Stores",
        "LoadStores",
      ...
      template<> std::pair<DecodeFailure, FEXCore::IR::BreakDefinition> DecodeValue(const fextl::string &Arg) {
        uint32_t tmp{};
      ...
      template<> std::pair<DecodeFailure, FEXCore::IR::OpSize> DecodeValue(const fextl::string &Arg) {
      ...
      template<> std::pair<DecodeFailure, OrderedNode *> DecodeValue(const fextl::string &Arg) {
        if (Arg.at(0) != '%') return {DecodeFailure::DECODE_INVALIDCHAR, 0};
      ...
      IRParser(FEXCore::Utils::IntrusivePooledAllocator &ThreadAllocator, fextl::stringstream &MapsStream) : IREmitter{ThreadAllocator} {
        InitializeNameMap();
          ...
          if (Def.HasArgs) {
            ...
            if (RemainingLine.empty()) {
              ...
              while (!RemainingLine.empty()) {
                ...
                if (ArgEnd == fextl::string::npos) break;
              }
            }
          }
