...
namespace FEXCore::Allocator {
  ...
  inline void VirtualFree(void *Ptr, size_t Size) { ::VirtualFree(Ptr, Size, MEM_RELEASE); }
  ...
  inline void VirtualFree(void *Ptr, size_t Size) { FEXCore::Allocator::munmap(Ptr, Size); }
  inline void VirtualDontNeed(void *Ptr, size_t Size) { ::madvise(reinterpret_cast<void *>(Ptr), Size, MADV_DONTNEED); }
#endif
  ...
  inline void *valloc(size_t size) { return ::_aligned_malloc(size, 4096); }
  ...
  struct FEXAllocOperators {
    ...
    void *operator new(size_t size) { return FEXCore::Allocator::malloc(size); }

    void *operator new(size_t size, std::align_val_t align) { return FEXCore::Allocator::aligned_alloc(static_cast<size_t>(align), size); }

    void operator delete(void *ptr) { return FEXCore::Allocator::free(ptr); }

    void operator delete(void *ptr, std::align_val_t align) { return FEXCore::Allocator::aligned_free(ptr); }
  };
}
